...
import edu.feng.trend.client.IndexDataClient;
import edu.feng.trend.pojo.AnnualProfit;
import edu.feng.trend.pojo.IndexData;
import edu.feng.trend.pojo.Profit;
import edu.feng.trend.pojo.Trade;
...
public class BackTestService {
    ...
    public List<IndexData> listIndexData(String code) throws Exception {
    ...
    /**
     * @param ma            移动均线 收盘价相加/时间
     * @param sellRate      卖出阈值
     * @param buyRate       购买阈值 百分比相对于最高点
     * @param serviceCharge 手续费
     * @param indexDatas    模拟回测
     * @return
     */
